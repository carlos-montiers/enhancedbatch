...
gcc -Wl,-e,_dllstart -nostartfiles -O3 -s -m64 -shared -lshell32 dll_enhancedbatch.c extensions.c offsets.c enhancedbatch_info_amd64.o -o enhancedbatch_amd64.dll -Wall
