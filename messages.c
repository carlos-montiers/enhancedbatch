...
const WCHAR EchoHelpStr[] =
	L"Display a message.\r\n"
	L"\r\n"
	L"CALL @ECHO [/C] [/E[c]] [/N] [/U] [/V] [//] message\r\n"
	L"\r\n"
	...
	L"to preserve spacing.  The escape character is \\ by default, supply c to use\r\n"
	L"any non-alphanumeric except ?, which will list the supported escapes."
;
